...
import { Fzf } from "fzf"
import { myMessage, defaultSetting } from "~/default"
  ...
  createEffect(() => {
    if (messageList().length === 0) {
      setMessageList([
        {
          role: "system",
          content: "你是我的助手，我想用flowable业务流程控制我的机器人，接下来我会教你如何实现控制机器人，我需要你的回答是bpmn20.xml文件,不需要定义bpmndi，另外我不需要关于流程设计过多的解释，不需要任何过多的解释。"
        },
        {
          role: "user",
          content: myMessage
